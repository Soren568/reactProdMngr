...
const ProductForm = () => {
    ...
    const handleGetAll = e => {
        e.preventDefault();
        axios.get('http://localhost:8000/api/products').then(res=>console.log(res)).catch(err=> console.log(err))
    }
    ...
    return (
        <div >
            ...
            <button onClick={handleGetAll} className="shadow bg-purple-50 hover:bg-purple-300 focus:shadow-outline py-2 px-4 text-xs rounded-lg flex focus:ring-2 focus:ring-purple-500 focus:ring-inset">Get All</button>
        </div>
    )
}
